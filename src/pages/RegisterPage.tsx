...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // If email verification is required, tokens won't be returned
      setRegistered(true);
    } catch (err) {
      ...
      <>
        ...
        <div style={pageStyle}>
          <div style={cardStyle}>
            ...
            <div style={{ ...subtitleStyle, marginBottom: '24px' }}>Регистрация почти завершена</div>
            <div style={successStyle}>
              На указанный email отправлено письмо с ссылкой для подтверждения.
              <br /><br />
              Пожалуйста, проверьте почту и перейдите по ссылке, затем войдите в аккаунт.
            </div>
            <button
              type="button"
